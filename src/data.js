...
A largo plazo, los nodos se integran en 44Mesh / 44Net para formar un radiotelescopio virtual distribuido capaz de coordinar observaciones simultáneas y explorar técnicas interferométricas VLBI. WANDA también se piensa como parte explícita de la red sensórica mayor de AlterMundi, compartiendo infraestructura y protocolos con nodos que observan la Tierra.`,
    ...
    relatedNodes: ["geas", "research", "networks"],
    links: [],
    repos: [],
...

  {
    ...
    radius: 14,
    category: "observacion",
    quote: "El nodo que mira el territorio y activa alertas tempranas frente al fuego.",
    shortDescription: "Plataforma abierta de detección temprana de incendios forestales. Nodos con cámaras 360°, IA de visión por computador, alertas Telegram, aprendizaje continuo.",
    longDescription: `SAI es una plataforma abierta de detección temprana de incendios forestales desarrollada para contextos rurales, especialmente en Córdoba, Argentina. Arquitectura basada en nodos con cámaras Reolink 360°, Raspberry Pi para adquisición y validación, orquestación en N8n y un servidor central de inferencia donde un modelo de visión por computador analiza humo y fuego en tiempo casi real.

Cuando se supera el umbral definido, el sistema envía alertas por Telegram a autoridades locales y al equipo técnico. La validación humana forma parte del aprendizaje continuo. Al menos un nodo piloto operativo en La Rancherita, con casos reales detectados durante pruebas de campo.`,
    keyIdeas: [
      "Percepción localizada + respuesta operativa rápida",
      "Aprendizaje continuo validado por humanos",
      "Infraestructura de bajo costo y escalable",
      "Gestión comunitaria del riesgo ambiental",
    ],
    features: [
      "Cámaras Reolink 360° en cada nodo",
      "Raspberry Pi + N8n + servidor de inferencia",
      "IA de visión por computador (humo y fuego)",
      "Alertas automáticas por Telegram",
      "Aprendizaje continuo con validación humana",
      "Piloto operativo en La Rancherita, Córdoba",
    ],
    relatedNodes: ["geas", "research", "networks"],
    links: [{ label: "SAI Web", url: "https://sai.altermundi.net" }],
    repos: [{ label: "sai-sainet-latest", url: "https://github.com/AlterMundi/sai-sainet-latest" }],
    status: "Piloto Córdoba operativo",
    statusColor: "#ea580c",
  },

  {
    ...
    title: "Agro",
    shortLabel: "Agro",
    subtitle: "Soberanía alimentaria y tecnológica",
    color: "#4d7c0f",
    glowColor: "rgba(77,124,15,0.5)",
    radius: 14,
    category: "agro",
    quote: "De la incubación avícola a la forestación: una misma arquitectura de soberanía productiva.",
    shortDescription: "Familia de tecnologías abiertas para la producción agroecológica, monitoreo, control e inteligencia productiva. Desarrolladas con organizaciones de la Agricultura Familiar, Campesina e Indígena.",
    longDescription: `La rama Agro surge del trabajo territorial con organizaciones de la Agricultura Familiar, Campesina e Indígena, de la colaboración con CTO y de una metodología participativa donde las tecnologías se diseñan a partir de necesidades concretas de producción y vida.

Esta familia responde a una triple dependencia estructural del sector: genética, alimentaria y tecnológica. Cada herramienta busca recuperar soberanía productiva y posibilitar una transición agroecológica integral, escalando desde avicultura a horticultura y forestación.`,
    keyIdeas: [
      "Triple dependencia: genética, alimentaria, tecnológica",
      "Diseño participativo con AFCI",
      "Escalado desde avicultura a horticultura y forestación",
      "Stack abierto: IoT, ERP, IA, trazabilidad",
    ],
    features: [
      "Soberanía tecnológica y alimentaria",
      "Producción agroecológica",
      "Monitoreo y control abierto",
      "IoT + datos + interfaces accesibles",
      "Certificación digital y trazabilidad",
    ],
    relatedNodes: ["libreincu", "libreagro", "geas", "networks"],
    links: [],
    repos: [],
    status: "En expansión",
    statusColor: "#4d7c0f",
...
export const LINKS = [
  ...
  { source: "geas", target: "wanda", strength: 0.9 },
